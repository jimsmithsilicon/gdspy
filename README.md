...
--------------------
16/6/20  Fork to add option to  read_gds  to  give a hash  for simultanous   gds_number/type pair
Foundry had multiple layers on same  gds  number,  with different datatypes.
Changed library.py.
Usage example:
...
#This hash will replace a given   layer,datatype  with a new  layer,datatype  to put the masks onto their own gds layer.
